###########################################################################
## Makefile generated for component 'arduino_run'. 
## 
## Makefile     : arduino_run.mk
## Generated on : Mon Sep 05 16:02:32 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_run.elf
...
SLIB_PATH                 = C:/Users/isamu/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_run.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=2
...
DEFINES_STANDARD = -DMODEL=arduino_run -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o arduino_run.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/arduino_run_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_run_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_run_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ServoWriteRead.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/arduinobase/src/MW_ServoWriteRead.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduino_run.o : $(START_DIR)/arduino_run_ert_rtw/arduino_run.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_run_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
